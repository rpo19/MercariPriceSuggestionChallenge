...
\begin{figure}[h!]
	...
	\caption{Keras Embedding, sezione testo del modello; si mostra l'approccio finale dove per Bi\_LSTM si intendono layer LSTM bidirezionali con dropout a 0.2.}
