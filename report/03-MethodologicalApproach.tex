...
\begin{itemize}
	...
	vocabolario di 400 mila parole; il più "piccolo" tra i pre-addrestrati.
	\item Common Crawl: allenato su 840 miliardi di parole e con un vocabolario
	di 2.2 milioni di parole; il più grande.
\end{itemize}
...
preaddestrati ai layer Embedding che sono stati impostati come non-trainabili.
